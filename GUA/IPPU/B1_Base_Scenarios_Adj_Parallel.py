...
#            f.write( 'param ' + this_param + ':=\n' )
    ...
    #     g.write('param AnnualEmissionLimit default 999999999999 :=\n;\n')
    ...
    g.write('param ModelPeriodEmissionLimit default 999999999999 :=\n;\n')
    ...
    g.write('param TotalAnnualMaxCapacityInvestment default 999999999999 :=\n;\n')
    #g.write('param TotalAnnualMaxCapacity default 999999999 :=\n;\n')
    #if scenario_list[scen] == 'BAU':
    g.write('param TotalAnnualMinCapacity default 0 :=\n;\n')
    # g.write('param TotalTechnologyAnnualActivityUpperLimit default 999999999999 :=\n;\n')
    g.write('param TotalTechnologyModelPeriodActivityLowerLimit default 0 :=\n;\n')
    g.write('param TotalTechnologyModelPeriodActivityUpperLimit default 999999999999 :=\n;\n')
    ...
    g.write('param TotalAnnualMaxCapacity default 999999999999 :=\n;\n')
    #
    g.write('#\n' + 'end;\n')
    #
    g.close()
                    ...
                    if ippu_Params_method == 'Exact': # only modify demands and capacities if this is turned on
                        ...
                        if ippu_Params_built_in == 'YES':
                            if ippu_Params_setIndex not in ['e']:
                                ...
                                #
                                if param_str in ['CapitalCost']:
                                    new_value_list = [value_list_new_vals[e] for e in range(len(value_list))]
