...
def execute_local_dataset_creator_0_outputs ():
    ...
    file_adress = file_aboslute_address.replace( 'local_dataset_creator_0.py', '' )
    file_adress +='/Executables/'
    #
    case_list_raw = os.listdir( file_adress )
    case_list =  [e for e in case_list_raw if ('.py' not in e ) and ('.csv' not in e ) and ('__pycache__' not in e) and ('.DS_Store' not in e)]
    li = []
