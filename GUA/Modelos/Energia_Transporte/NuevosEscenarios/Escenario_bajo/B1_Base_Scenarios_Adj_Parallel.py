...
if __name__ == '__main__':
    # __file__ = '/Users/edmiranda/Documents/Trabajo 2021/Investigación/Descarbonizacion/Modelo Tutorial/Febrero2022/OSeMOSYS_GUA_v20220225/B1_Base_Scenarios_Adj_Parallel.py'
    #
    ...
    *Abbreviations:*
    ...
    for s in range( len( scenario_list ) ):
        ...
        if scenario_list[s] == 'NDP':
           ...
           zzz1b = list(set(list(stable_scenarios['NDP']['TotalTechnologyAnnualActivityLowerLimit']['t'])))
           print('zzz1', len(zzz1), len(zzz1b))
            # list zzz1 and zz1b to a csv file

           pd.DataFrame(zzz1 + zzz1b).to_csv('zzz1.csv')
        ...
        for t in range(len(rewrite_techs_maxcap)):
            ...
            # TODO
            print(t, rewrite_techs_maxcap[t], Fleet_Groups_inv[this_set], scenario_list[s], len(group_value_list))
            # pd.DataFrame(stable_scenarios_freeze).to_csv(f'stable_scenarios_freeze{t}.csv')
            print(group_value_list)
            print(freeze_value_list)
            print(freeze_group_value_list)
    ...
    if is_this_last_update == True:
        ...
        for n in range(len(scenario_list)):
            csv_printer_parallel(n,scenario_list, stable_scenarios, basic_header_elements, parameters_to_print, S_DICT_params_structure)
    ...
    if generator_or_executor == 'Executor' or generator_or_executor == 'Both':
        ...
        # This is for the linear version
        # for n in range( 1 ):
        #     print(n,packaged_useful_elements,scenario_list_print)
        #     print(first_list)
