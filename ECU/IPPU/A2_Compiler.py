...
for d in range( len( list_dicts ) ):
    ...
    df_to_print = df_to_print.replace( { 'Scenario':{ other_setup_params[ 'Main_Scenario' ]:"NDCincond"} } )
...
#    df_to_print = df_to_print.replace( { 'Scenario':{"NDCcond":"TREND3"} } )
#    df_to_print.to_csv( './A2_Output_Params/TREND3/' + list_dicts[d] + '.csv', index=False, header=True)
#
end_2 = time.time()   
