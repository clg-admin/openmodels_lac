...
def data_processor( case, unpackaged_useful_elements ):
    ...
    for var in range( len( vars_as_appear ) ):
        ...
        for k in range( len( this_var_dict[this_variable] ) ):
            ...
            #
            externality_list = ['Accidents', 'Health', 'Congestion', 'RM', 'FERT_ORG', 'salud_residuos', 'contam_agua', 'turismo_residuos','turismo_residuos', 'water_reuse','CONHAB', 'CONTUR', 'CONVAR', 'CONHICK', 'RESHID', 'DAPANI']
