...
def data_processor( case, unpackaged_useful_elements ):
    ...
    for var in range( len( vars_as_appear ) ):
        ...
        for k in range( len( this_var_dict[this_variable] ) ):
            ...
            #
            externality_list = [
                'Accidents', 'Health', 'Congestion', 'RM', 'FERT_ORG', 'salud_residuos', 'contam_agua', 
                'turismo_residuos','turismo_residuos', 'CONHAB', 'CONTUR', 'CONVAR', 'CONHICK', 'RESHID', 'DAPANI',
                'HAB', 'CONSOIL', 'CON', 'CONAG']
...
#            f.write( 'param ' + this_param + ':=\n' )
    ...
    g.write('param TotalAnnualMaxCapacity default 999999999999999999999 :=\n;\n')
