...
technology_list = [
    ...
    "IMPLEG", "IMPROT", "IMPFRT", "IMPCER", "IMPOTP", "IMPLEC", "IMPCARAVI", "IMPCARBOV", "IMPOTRCARPRO",
    "IMPCARPOR", "IMPOTRCAR", "INORG_RCY_OS", "COMPOST", "LANDFILL", "NO_CONTR_OD", "OPEN_BURN", "SIT_CLAN", "AD",
    "AERO_PTAR", "AERO_PTAR_RU", "ANAE_LAGN", "ANAE_LAGN_RU", "SEPT_SYST", "LATR", "EFLT_DISC", "SEWER_NO_T",
    "RAW_MAT_CLK", "RAW_MAT_CEM", "IMP_STOR", "REF_DSL", "REF_GSL", "REF_LPG", "REF_FOI", "PPBIM", "PPBGS", "PPCOA",
    "PPCCTDSL", "PPCCFOIDSL", "PPCCTNGS", "PPCCTNGSDSL", "PPICEFOI", "PPICEGASFOI", "ELE_TRANS", "HYD_G_PROD",
    "ELE_DIST", "HYD_DIST", "LU_FOR", "LU_AGR", "LU_GAN", "LU_MTS", "LU_SAB", "LU_URB", "LU_OLU", "LU_LATHUM",
    "LU_CLF", "LU_LATSHUM", "LU_DCON", "LU_SCON", "LU_WET", "LU_DRY", "AG_RIC", "AG_BAN", "AG_SGC", "AG_COC",
    "AG_TRVEG", "AG_CAF", "AG_LEG", "AG_ROT", "AG_FRT", "AGR_CER", "AGR_OTP", "GA_LEC", "GA_CARAVI", "GA_CARBOV",
    "GA_CARPOR", "GA_OTRCARPRO", "GA_OTRCAR", "OSS_INORG", "OSS_ORG", "NO_OSS_BLEND", "NO_OSS_NO_COLL",
    "INORG_DCOLL", "ORG_DCOLL", "BLEND_NO_DCOLL", "BLEND_NO_COLL", "INORG_SS", "ORG_SS", "NO_SS", "WWWT", "WWWOT",
    "SEWERWW", "DIRECT_DISC", "PROD_CLK_TRAD", "PROD_CEM", "T5DSLCOM", "T5GSLCOM", "T5NGSCOM", "T5LPGCOM",
    "T5ELECOM", "T5FIRCOM", "T5DSLIND", "T5GSLIND", "T5NGSIND", "T5LPGIND", "T5ELEIND", "T5HYDIND", "T5COKIND",
    "T5BIMIND", "T5COAIND", "T5FOIIND", "T5LPGRES", "T5ELERES", "T5KERRES", "T5FIRRES", "T5BIMRES", "T5GSLCON",
    "T5LPGCON", "T5NGSEXP", "T5KEREXP", "T5BIMEXP", "T5DSLTOT", "T5GSLTOT", "T5ELETOT", "T5GSLTAC", "T5KERTAC",
    "T5DSLAGR", "T5LPGAGR", "T5ELEAGR", "T5SGCAGR", "T5RICAGR", "T5CERAGR", "T5BANAGR", "T5TRVEGAGR", "T5CAFAGR",
    "T5COCAGR", "T5LEGAGR", "T5ROTAGR", "T5FRTAGR", "T5OTPAGR", "T5LECGAN", "T5CARAVIGAN", "T5CARBOVGAN",
    "T5CARPORGAN", "T5OTRCARPROGAN", "T5OTRCARGAN", "T5SGCAGREXP", "T5CAFAGREXP", "T5RICAGREXP", "T5CERAGREXP",
    "T5BANAGREXP", "T5TRVEGAGREXP", "T5COCAGREXP", "T5LEGAGREXP", "T5ROTAGREXP", "T5FRTAGREXP", "T5OTPAGREXP",
    "T5LECGANEXP", "T5CARAVIGANEXP", "T5CARBOVGANEXP", "T5CARPORGANEXP", "T5OTRCARPROGANEXP", "T5OTRCARGANEXP",
    "T5MTSCOB", "T5SABCOB", "T5URBCOB", "T5OLUCOB", "T5LATHUMBOS", "T5CLFBOS", "T5LATSHUMBOS", "T5DCONBOS",
    "T5SCONBOS", "T5WETBOS", "T5DRYBOS", "T5TSWTSW", "T5TWWTWW", "T5CEM_PRODCEM_PROD", "T4DSL_PRI", "T4GSL_PRI",
    "T4LPG_PRI", "T4ELE_PRI", "T4NGS_PRI", "T4DSL_PUB", "T4GSL_PUB", "T4LPG_PUB", "T4ELE_PUB", "T4HYD_PUB",
    "T4DSL_TUR", "T4GSL_TUR", "T4LPG_TUR", "T4ELE_TUR", "T4HYD_TUR", "T4ELE_HEA", "T4DSL_HEA", "T4GSL_HEA",
    "T4LPG_HEA", "T4HYD_HEA", "T4DSL_LIG", "T4GSL_LIG", "T4LPG_LIG", "T4ELE_LIG", "T4NGS_LIG", "TRAUTDSL",
    "TRAUTGSL", "TRAUTLPG", "TRAUTELE", "TRAUTHG", "TRTAXGSL", "TRTAXLPG", "TRTAXELE", "TRMOTGSL", "TRMOTELE",
    "TRSUVDSL", "TRSUVGSL", "TRSUVLPG", "TRSUVELE", "TRSUVNGS", "TRBPUDSL", "TRBPUGSL", "TRBPULPG", "TRBPUELE",
    "TRBPUHYD", "TRBTURDSL", "TRBTURGSL", "TRBTURLPG", "TRBTURELE", "TRBTURHYD", "TRMBSDSL", "TRMBSGSL", "TRMBSLPG",
    "TRMBSELE", "TRXTTELELE", "TRXTRAIELE", "TRXTRAIFREELE", "TRYTKDSL", "TRYTKGSL", "TRYTKLPG", "TRYTKELE", "TRYTKHYD",
    "TRYTKHD", "TRYLFDSL", "TRYLFGSL", "TRYLFLPG", "TRYLFELE", "TRYLFNGS", "TRYLFHD", "Techs_Auto", "Techs_Taxi",
    "Techs_Motos", "Techs_SUV", "Techs_Buses_Pub", "Techs_Buses_Tur", "Techs_Buses_Micro", "Techs_Telef",
    "Techs_Trains", "Techs_Trains_Freight", "Techs_He_Freight", "Techs_Li_Freight", "TRANE6NOMOT", "TRANRAILINF",
    "PROD_CAL", "PROD_FERRO", "REFR_AC", "OTHER", "IWW", "LANDFILL_ELEC", "R134a", "R404A", "R410A", "SUB134a",
    "SUB404A", "SUB410A", "COPROC", "INCIN"
]
...
dir_bau_files = './Executables/'+scen
...
for f in folders:
    ...
    with open(f'tests_results\comparison_results_{f}.txt', 'a') as file_results:
        file_results.write("\n\n\n Compare TotalAnnualMaxCapacity with TotalTechnologyAnnualActivityLowerLimit")
        ...
        for tech in technology_list_with_lower_limit:
            ...
            if any(x < 0 for x in difference_list):
                ...
                file_results.write(f"Warning 1: Negative value detected in difference_list for tech {tech}!")
                ...
                for i in range(1, len(this_maxcap_list_new)):
                    if this_maxcap_list_new[i] < this_maxcap_list_new[i-1]:
                        if not warning_printed:  # Only print the warning if it hasn't been printed yet
                            ...
                            file_results.write(f"Warning 2: Found decreasing values in this_maxcap_list_new for tech {tech}")
