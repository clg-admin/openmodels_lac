...
'''
We implement OSEMOSYS-RD in a csv based system for semi-automatic manipulation of parameters.
'''
...
def data_processor( case, unpackaged_useful_elements ):
    ...
    #list_param_default_value_params = unpackaged_useful_elements[1]
    #list_param_default_value_value = unpackaged_useful_elements[2]
    ...
    for var in range( len( vars_as_appear ) ):
        ...
        for k in range( len( this_var_dict[this_variable] ) ):
            ...
            #
            if this_combination[2] in ['RM','FERT_ORG','FERT_ORG','salud_residuos','contam_agua','salud_residuos','salud_residuos','contam_agua','turismo_residuos','water_reuse'] and this_variable == 'AnnualTechnologyEmissionPenaltyByEmission':
                ...
                this_data_row[new2_var_position_index] = np.nan #str( float(this_data_row[ ref_var_position_index ])/list_gdp_ref[this_year_index] )
                #
                data_row_list[ ref_index ] = deepcopy( this_data_row )
                #
            #
...
def function_C_mathprog( scen, stable_scenarios, unpackaged_useful_elements ):
    ...
    #time_range_vector =                 unpackaged_useful_elements[6] #unpackaged_useful_elements[8]
...
#            f.write( 'param ' + this_param + ':=\n' )
    ...
    #     g.write('param AnnualEmissionLimit default 9999999999 :=\n;\n')
    ...
    g.write('param ModelPeriodEmissionLimit default 9999999999 :=\n;\n')
    ...
    g.write('param TotalAnnualMaxCapacityInvestment default 9999999999 :=\n;\n')
    #g.write('param TotalAnnualMaxCapacity default 9999999999 :=\n;\n')
    #if scenario_list[scen] == 'BAU':
    g.write('param TotalAnnualMinCapacity default 0 :=\n;\n')
    # g.write('param TotalTechnologyAnnualActivityUpperLimit default 9999999999 :=\n;\n')
    g.write('param TotalTechnologyModelPeriodActivityLowerLimit default 0 :=\n;\n')
    g.write('param TotalTechnologyModelPeriodActivityUpperLimit default 9999999999 :=\n;\n')
...
if __name__ == '__main__':
    #
    all_years = [ y for y in range( 2018 , 2050+1 ) ] # 2018 , 2050+1
    ...
    *Abbreviations:*
    ...
    for s in range( len( scenario_list ) ):
        ...
        #     ''' MODIFYING *base_configuration_ippu* '''
        ...
        #                             stable_scenarios[scenario_list[s]][param_list[p]]['r'].append(REGION_STR)
    ...
    #         else:
    #             Blend_Shares.update( { this_scenario_name:Blend_Shares[ LTS_STR ] } )
