...
start_1 = time.time()
di_nam = 'data_inputs_20231030.xlsx'
    ...
    for r in range(len(regions_list)):
        ...
        for c in range(len(country_list)):
            ...
            if model_agro_and_waste:
                ...
                mask_rice_ir = (df3_agr_data_scen['Type'] == 'Alimentado por lluvia')  # unit: ha
                ...
                mask_fe_rice_ir = (df4_ef_agro_res_scen['Group'] == 'Cultivo de arroz') &\
                    (df4_ef_agro_res_scen['Type'] == 'Cultivo de arroz alimentado por lluvia')
                ...
                dict_local_country[this_country].update({'Emisiones de cultivo de arroz alimentado por lluvia [kton CH4]': deepcopy(rice_ir_emis)})
                dict_local_country[this_country].update({'OPEX para cultivo de arroz alimentado por lluvia [MUSD]': deepcopy(out_opex_rice_proj_dict)})
                dict_local_country[this_country].update({'CAPEX para cultivo de arroz alimentado por lluvia[MUSD]': deepcopy(out_capex_rice_proj_dict)})
                dict_local_country[this_country].update({'OPEX para cultivo de arroz alimentado por lluvia [MUSD](disc)': deepcopy(out_opex_rice_proj_dict_disc)})
                dict_local_country[this_country].update({'CAPEX para cultivo de arroz alimentado por lluvia [MUSD](disc)': deepcopy(out_capex_rice_proj_dict_disc)})
                
                
                #data for aerated rice
                mask_rice_ar = (df3_agr_data_scen['Type'] == 'Irrigado')  # unit: ha
                ...
                # Grabbing CAPEX:
                d5_rice_ar_capex_mask = (d5_agr['Tech'] == 'Cultivo_arroz_irrigado_CAPEX') &\
                    (d5_agr['Scenario'] == this_scen)
                ...
                # Grabbing operational life:
                d5_rice_ar_ol_mask = (d5_agr['Tech'] == 'Cultivo_arroz_irrigado') &\
                    (d5_agr['Scenario'] == this_scen)
                ...
                # Grabbing OPEX:
                d5_rice_ar_opex_mask = (d5_agr['Tech'] == 'Cultivo_arroz_irrigado_OPEX') &\
                    (d5_agr['Scenario'] == this_scen)
                ...
                dict_local_country[this_country].update({'Emisiones de cultivo de arroz por irrigado [kton CH4]': deepcopy(rice_ar_emis)})
                dict_local_country[this_country].update({'OPEX para cultivo de arroz por irrigado [MUSD]': deepcopy(out_opex_rice_proj_dict)})
                dict_local_country[this_country].update({'CAPEX para cultivo de arroz por irrigado [MUSD]': deepcopy(out_capex_rice_proj_dict)})
                dict_local_country[this_country].update({'OPEX para cultivo de arroz por irrigado [MUSD](disc)': deepcopy(out_opex_rice_proj_dict_disc)})
                dict_local_country[this_country].update({'CAPEX para cultivo de arroz por irrigado [MUSD](disc)': deepcopy(out_capex_rice_proj_dict_disc)})
...
list_outputs = ['Electricity CAPEX', #1
                ...
                'Emisiones de cultivo de arroz alimentado por lluvia [kton CH4]', # 103
                'OPEX para cultivo de arroz alimentado por lluvia [MUSD]', # 104
                'CAPEX para cultivo de arroz alimentado por lluvia[MUSD]', # 105
                'OPEX para cultivo de arroz alimentado por lluvia [MUSD](disc)', # 106
                'CAPEX para cultivo de arroz alimentado por lluvia [MUSD](disc)', # 107
                'Emisiones de cultivo de arroz por irrigado [kton CH4]', # 108
                'OPEX para cultivo de arroz por irrigado [MUSD]', # 109
                'CAPEX para cultivo de arroz por irrigado [MUSD]', # 110
                'OPEX para cultivo de arroz por irrigado [MUSD](disc)', # 111
                'CAPEX para cultivo de arroz por irrigado [MUSD](disc)', # 112
                ...
                for fuel in list_fuel_clean:
                    for y in range(len(time_vector)):
                        ...
                        if tech in list_demand_sector_techs:
                            ...
                            tech_type = 'waste externalities'
                        elif tech in types_livestock:
                            tech_type = 'cattle farming'
                        elif tech in types_liv_opex:
                            tech_type = 'costs for cattle farming'
                        elif tech in types_rice_capex + types_rice_opex + types_rice_opex_2:
                            tech_type = 'costs for rice growth'
                        elif tech in types_shares_ac:
                            tech_type = 'AC subsector'
                        elif tech in types_shares_ref:
                            tech_type = 'refrigeration subsector'
                        elif tech in types_shares_ext:
                            tech_type = 'extinguishers subsector'
                        elif tech == types_industry:
                            tech_type = 'Industrial waterwaste'
                        elif tech == '':
                            tech_type = ''
                        else:
                            tech_type = 'none'
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o72.append(this_data_dict[list_outputs[71]][tech][y])
                            except Exception:
                                h_o72.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o73.append(this_data_dict[list_outputs[72]][tech][y])
                            except Exception:
                                h_o73.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o74.append(this_data_dict[list_outputs[73]][tech][y])
                            except Exception:
                                h_o74.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o75.append(this_data_dict[list_outputs[74]][tech][y])
                            except Exception:
                                h_o75.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o76.append(this_data_dict[list_outputs[75]][tech][y])
                            except Exception:
                                h_o76.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o77.append(this_data_dict[list_outputs[76]][tech][y])
                            except Exception:
                                h_o77.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o78.append(this_data_dict[list_outputs[77]][tech][y])
                            except Exception:
                                h_o78.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel != '' and tech != '':
                            try:
                                h_o79.append(this_data_dict[list_outputs[78]][tech][fuel][y])
                            except Exception:
                                h_o79.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o80.append(this_data_dict[list_outputs[79]][tech][y])
                            except Exception:
                                h_o80.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o81.append(this_data_dict[list_outputs[80]][tech][y])
                            except Exception:
                                h_o81.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o82.append(this_data_dict[list_outputs[81]][tech][y])
                            except Exception:
                                h_o82.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o83.append(this_data_dict[list_outputs[82]][tech][y])
                            except Exception:
                                h_o83.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o84.append(this_data_dict[list_outputs[83]][y])
                            except Exception:
                                h_o84.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o85.append(this_data_dict[list_outputs[84]][y])
                            except Exception:
                                h_o85.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o86.append(this_data_dict[list_outputs[85]][tech][y])
                            except Exception:
                                h_o86.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o87.append(this_data_dict[list_outputs[86]][tech][y])
                            except Exception:
                                h_o87.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o88.append(this_data_dict[list_outputs[87]][tech][y])
                            except Exception:
                                h_o88.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o89.append(this_data_dict[list_outputs[88]][tech][y])
                            except Exception:
                                h_o89.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o90.append(this_data_dict[list_outputs[89]][tech][y])
                            except Exception:
                                h_o90.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o91.append(this_data_dict[list_outputs[90]][tech][y])
                            except Exception:
                                h_o91.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o92.append(this_data_dict[list_outputs[91]][tech][y])
                            except Exception:
                                h_o92.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o93.append(this_data_dict[list_outputs[92]][tech][y])
                            except Exception:
                                h_o93.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o94.append(this_data_dict[list_outputs[93]][y])
                            except Exception:
                                h_o94.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o95.append(this_data_dict[list_outputs[94]][y])
                            except Exception:
                                h_o95.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o96.append(this_data_dict[list_outputs[95]][y])
                            except Exception:
                                h_o96.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o97.append(this_data_dict[list_outputs[96]][y])
                            except Exception:
                                h_o97.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o98.append(this_data_dict[list_outputs[97]][y])
                            except Exception:
                                h_o98.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o99.append(this_data_dict[list_outputs[98]][tech][y])
                            except Exception:
                                h_o99.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o100.append(this_data_dict[list_outputs[99]][tech][y])
                            except Exception:
                                h_o100.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o101.append(this_data_dict[list_outputs[100]][tech][y])
                            except Exception:
                                h_o101.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o102.append(this_data_dict[list_outputs[101]][tech][y])
                            except Exception:
                                h_o102.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o103.append(this_data_dict[list_outputs[102]][y])
                            except Exception:
                                h_o103.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o104.append(this_data_dict[list_outputs[103]][tech][y])
                            except Exception:
                                h_o104.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o105.append(this_data_dict[list_outputs[104]][tech][y])
                            except Exception:
                                h_o105.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o106.append(this_data_dict[list_outputs[105]][tech][y])
                            except Exception:
                                h_o106.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o107.append(this_data_dict[list_outputs[106]][tech][y])
                            except Exception:
                                h_o107.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o108.append(this_data_dict[list_outputs[107]][y])
                            except Exception:
                                h_o108.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o109.append(this_data_dict[list_outputs[108]][tech][y])
                            except Exception:
                                h_o109.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o110.append(this_data_dict[list_outputs[109]][tech][y])
                            except Exception:
                                h_o110.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o111.append(this_data_dict[list_outputs[110]][tech][y])
                            except Exception:
                                h_o111.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o112.append(this_data_dict[list_outputs[111]][tech][y])
                            except Exception:
                                h_o112.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o113.append(this_data_dict[list_outputs[112]][y])
                            except Exception:
                                h_o113.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o114.append(this_data_dict[list_outputs[113]][y])
                            except Exception:
                                h_o114.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o115.append(this_data_dict[list_outputs[114]][y])
                            except Exception:
                                h_o115.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o116.append(this_data_dict[list_outputs[115]][y])
                            except Exception:
                                h_o116.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o117.append(this_data_dict[list_outputs[116]][y])
                            except Exception:
                                h_o117.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o118.append(this_data_dict[list_outputs[117]][y])
                            except Exception:
                                h_o118.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o119.append(this_data_dict[list_outputs[118]][y])
                            except Exception:
                                h_o119.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o120.append(this_data_dict[list_outputs[119]][y])
                            except Exception:
                                h_o120.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o121.append(this_data_dict[list_outputs[120]][y])
                            except Exception:
                                h_o121.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o122.append(this_data_dict[list_outputs[121]][y])
                            except Exception:
                                h_o122.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o123.append(this_data_dict[list_outputs[122]][y])
                            except Exception:
                                h_o123.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o124.append(this_data_dict[list_outputs[123]][y])
                            except Exception:
                                h_o124.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o125.append(this_data_dict[list_outputs[124]][y])
                            except Exception:
                                h_o125.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o126.append(this_data_dict[list_outputs[125]][y])
                            except Exception:
                                h_o126.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o127.append(this_data_dict[list_outputs[126]][y])
                            except Exception:
                                h_o127.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o128.append(this_data_dict[list_outputs[127]][y])
                            except Exception:
                                h_o128.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o129.append(this_data_dict[list_outputs[128]][y])
                            except Exception:
                                h_o129.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o130.append(this_data_dict[list_outputs[129]][y])
                            except Exception:
                                h_o130.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o131.append(this_data_dict[list_outputs[130]][y])
                            except Exception:
                                h_o131.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o132.append(this_data_dict[list_outputs[131]][y])
                            except Exception:
                                h_o132.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o133.append(this_data_dict[list_outputs[132]][y])
                            except Exception:
                                h_o133.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o134.append(this_data_dict[list_outputs[133]][y])
                            except Exception:
                                h_o134.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o135.append(this_data_dict[list_outputs[134]][tech][y])
                            except Exception:
                                h_o135.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o136.append(this_data_dict[list_outputs[135]][tech][y])
                            except Exception:
                                h_o136.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o137.append(this_data_dict[list_outputs[136]][tech][y])
                            except Exception:
                                h_o137.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o138.append(this_data_dict[list_outputs[137]][tech][y])
                            except Exception:
                                h_o138.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o139.append(this_data_dict[list_outputs[138]][tech][y])
                            except Exception:
                                h_o139.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o140.append(this_data_dict[list_outputs[139]][tech][y])
                            except Exception:
                                h_o140.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o141.append(this_data_dict[list_outputs[140]][tech][y])
                            except Exception:
                                h_o141.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o142.append(this_data_dict[list_outputs[141]][tech][y])
                            except Exception:
                                h_o142.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o143.append(this_data_dict[list_outputs[142]][tech][y])
                            except Exception:
                                h_o143.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o144.append(this_data_dict[list_outputs[143]][y])
                            except Exception:
                                h_o144.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o145.append(this_data_dict[list_outputs[144]][y])
                            except Exception:
                                h_o145.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o146.append(this_data_dict[list_outputs[145]][tech][y])
                            except Exception:
                                h_o146.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o147.append(this_data_dict[list_outputs[146]][tech][y])
                            except Exception:
                                h_o147.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                ...
                                h_o148.append(this_data_dict[list_outputs[147]][tech][y])
                            except Exception:
                                h_o148.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                ...
                                h_o149.append(this_data_dict[list_outputs[148]][y])
                            except Exception:
                                h_o149.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                ...
                                h_o150.append(this_data_dict[list_outputs[149]][y])
                            except Exception:
                                h_o150.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o151.append(this_data_dict[list_outputs[150]][y])
                            except Exception:
                                h_o151.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o152.append(this_data_dict[list_outputs[151]][y])
                            except Exception:
                                h_o152.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel != '' and tech != '':
                            try:
                                # fuel_app = dict_eq_trn_fuels_rev[fuel]
                                h_o153.append(this_data_dict[list_outputs[152]][tech][fuel][y])
                            except Exception:
                                h_o153.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel != '' and tech != '':
                            try:
                                # fuel_app = dict_eq_trn_fuels_rev[fuel]
                                h_o154.append(this_data_dict[list_outputs[153]][tech][fuel][y])
                            except Exception:
                                h_o154.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel != '' and tech != '':
                            try:
                                # fuel_app = dict_eq_trn_fuels_rev[fuel]
                                h_o155.append(this_data_dict[list_outputs[154]][tech][fuel][y])
                            except Exception:
                                h_o155.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o156.append(this_data_dict[list_outputs[155]][y])
                            except Exception:
                                h_o156.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o157.append(this_data_dict[list_outputs[156]][y])
                            except Exception:
                                h_o157.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o158.append(this_data_dict[list_outputs[157]][y])
                            except Exception:
                                h_o158.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o159.append(this_data_dict[list_outputs[158]][y])
                            except Exception:
                                h_o159.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o160.append(this_data_dict[list_outputs[159]][y])
                            except Exception:
                                h_o160.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o161.append(this_data_dict[list_outputs[160]][y])
                            except Exception:
                                h_o161.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o162.append(this_data_dict[list_outputs[161]][y])
                            except Exception:
                                h_o162.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o163.append(this_data_dict[list_outputs[162]][y])
                            except Exception:
                                h_o163.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o164.append(this_data_dict[list_outputs[163]][y])
                            except Exception:
                                h_o164.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o165.append(this_data_dict[list_outputs[164]][y])
                            except Exception:
                                h_o165.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o166.append(this_data_dict[list_outputs[165]][y])
                            except Exception:
                                h_o166.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o167.append(this_data_dict[list_outputs[166]][y])
                            except Exception:
                                h_o167.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o168.append(this_data_dict[list_outputs[167]][y])
                            except Exception:
                                h_o168.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o169.append(this_data_dict[list_outputs[168]][y])
                            except Exception:
                                h_o169.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech == '':
                            try:
                                h_o170.append(this_data_dict[list_outputs[169]][y])
                            except Exception:
                                h_o170.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel != '' and tech != '':
                            try:
                                h_o171.append(this_data_dict[list_outputs[170]][tech][fuel][y])
                            except Exception:
                                h_o171.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o172.append(this_data_dict[list_outputs[171]][tech][y])
                            except Exception:
                                h_o172.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o173.append(this_data_dict[list_outputs[172]][tech][y])
                            except Exception:
                                h_o173.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o174.append(this_data_dict[list_outputs[173]][tech][y])
                            except Exception:
                                h_o174.append(0)
                                count_empties += 1
                        else:
                        ...
                        if fuel == '' and tech != '':
                            try:
                                h_o175.append(this_data_dict[list_outputs[174]][tech][y])
                            except Exception:
                                h_o175.append(0)
                                count_empties += 1
                        else:
                            h_o175.append(0)
                            count_empties += 1
                        if count_empties == 185:  # gotta pop, because it is an empty row:
                            h_i1.pop() #1
                            h_i2.pop() #2
                            h_i3.pop() #3
                            h_i4.pop() #4
...
list_variables = \
    [h_i1, h_i2, h_i3, h_i4, h_i5, h_i6, h_i7, h_i8, h_i9, h_i10,
     ...
     h_o71, h_o72, h_o73, h_o74, h_o75, h_o76, h_o77, h_o78, h_o79,
     h_o80, h_o81, h_o82, h_o83, h_o84, h_o85, h_o86, h_o87, h_o88, h_o89,
     h_o90, h_o91, h_o92, h_o93, h_o94, h_o95, h_o96, h_o97, h_o98, h_o99,
     h_o100, h_o101, h_o102, h_o103, h_o104, h_o105, h_o106, h_o107, h_o108, h_o109,
     h_o110, h_o111, h_o112, h_o113, h_o114, h_o115, h_o116, h_o117, h_o118, h_o119,
     h_o120, h_o121, h_o122, h_o123, h_o124, h_o125, h_o126, h_o127, h_o128, h_o129,
     h_o130, h_o131, h_o132, h_o133, h_o134, h_o135, h_o136, h_o137, h_o138, h_o139,
     h_o140, h_o141, h_o142, h_o143, h_o144, h_o145, h_o146, h_o147, h_o148, h_o149,
     h_o150, h_o151, h_o152, h_o153, h_o154, h_o155, h_o156, h_o157, h_o158, h_o159, 
     h_o160, h_o161, h_o162, h_o163, h_o164, h_o165, h_o166, h_o167, h_o168, h_o169,
     h_o170, h_o171, h_o172, h_o173, h_o174, h_o175]
h_count = 0
h_zeros = []
...
print(94, list_outputs_add[76], len(h_o77)) #94
print(95, list_outputs_add[77], len(h_o78)) #95

print(96, list_outputs_add[78], len(h_o79)) #96
print(97, list_outputs_add[79], len(h_o80)) #97
print(98, list_outputs_add[80], len(h_o81)) #98
print(99, list_outputs_add[81], len(h_o82)) #99
print(100, list_outputs_add[82], len(h_o83)) #100
print(101, list_outputs_add[83], len(h_o84)) #101
print(102, list_outputs_add[84], len(h_o85)) #102
print(103, list_outputs_add[85], len(h_o86)) #103
print(104, list_outputs_add[86], len(h_o87)) #104
print(105, list_outputs_add[87], len(h_o88)) #105
print(106, list_outputs_add[88], len(h_o89)) #106
print(107, list_outputs_add[89], len(h_o90)) #107
print(108, list_outputs_add[90], len(h_o91)) #108
print(109, list_outputs_add[91], len(h_o92)) #109
print(110, list_outputs_add[92], len(h_o93)) #110
print(111, list_outputs_add[93], len(h_o94)) #111
print(112, list_outputs_add[94], len(h_o95)) #112
print(113, list_outputs_add[95], len(h_o96)) #113
print(114, list_outputs_add[96], len(h_o97)) #114
print(115, list_outputs_add[97], len(h_o98)) #115
print(116, list_outputs_add[98], len(h_o99)) #116
print(117, list_outputs_add[99], len(h_o100)) #117
print(118, list_outputs_add[100], len(h_o101)) #118
print(119, list_outputs_add[101], len(h_o102)) #119
print(120, list_outputs_add[102], len(h_o103)) #120
print(121, list_outputs_add[103], len(h_o104)) #121
print(122, list_outputs_add[104], len(h_o105)) #122
print(123, list_outputs_add[105], len(h_o106)) #123
print(124, list_outputs_add[106], len(h_o107)) #124
print(125, list_outputs_add[107], len(h_o108)) #125
print(126, list_outputs_add[108], len(h_o109)) #126
print(127, list_outputs_add[109], len(h_o110)) #127
print(128, list_outputs_add[110], len(h_o111)) #128
print(129, list_outputs_add[111], len(h_o112)) #129
print(130, list_outputs_add[112], len(h_o113)) #130
print(131, list_outputs_add[113], len(h_o114)) #131
print(132, list_outputs_add[114], len(h_o115)) #132
print(133, list_outputs_add[115], len(h_o116)) #133
print(134, list_outputs_add[116], len(h_o117)) #134
print(135, list_outputs_add[117], len(h_o118)) #135
print(136, list_outputs_add[118], len(h_o119)) #136
print(137, list_outputs_add[119], len(h_o120)) #137
print(138, list_outputs_add[120], len(h_o121)) #138
print(139, list_outputs_add[121], len(h_o122)) #139
print(140, list_outputs_add[122], len(h_o123)) #140
print(141, list_outputs_add[123], len(h_o124)) #141
print(142, list_outputs_add[124], len(h_o125)) #142
print(143, list_outputs_add[125], len(h_o126)) #143
print(144, list_outputs_add[126], len(h_o127)) #144
print(145, list_outputs_add[127], len(h_o128)) #145
print(146, list_outputs_add[128], len(h_o129)) #146
print(147, list_outputs_add[129], len(h_o130)) #147
print(148, list_outputs_add[130], len(h_o131)) #148
print(149, list_outputs_add[131], len(h_o132)) #149
print(150, list_outputs_add[132], len(h_o133)) #150
print(151, list_outputs_add[133], len(h_o134)) #151
print(152, list_outputs_add[134], len(h_o135)) #152
print(153, list_outputs_add[135], len(h_o136)) #153
print(154, list_outputs_add[136], len(h_o137)) #154
print(155, list_outputs_add[137], len(h_o138)) #155
print(156, list_outputs_add[138], len(h_o139)) #156
print(157, list_outputs_add[139], len(h_o140)) #157
print(158, list_outputs_add[140], len(h_o141)) #158
print(159, list_outputs_add[141], len(h_o142)) #159
print(160, list_outputs_add[142], len(h_o143)) #160
print(161, list_outputs_add[143], len(h_o144)) #161
print(162, list_outputs_add[144], len(h_o145)) #162
print(163, list_outputs_add[145], len(h_o146)) #163
print(164, list_outputs_add[146], len(h_o147)) #164
print(165, list_outputs_add[147], len(h_o148)) #165
print(166, list_outputs_add[148], len(h_o149)) #166
print(167, list_outputs_add[149], len(h_o150)) #167
print(168, list_outputs_add[150], len(h_o151)) #168
print(169, list_outputs_add[151], len(h_o152)) #169
print(170, list_outputs_add[152], len(h_o153)) #170
print(171, list_outputs_add[153], len(h_o154)) #171
print(172, list_outputs_add[154], len(h_o155)) #172
print(173, list_outputs_add[155], len(h_o156)) #173
print(174, list_outputs_add[156], len(h_o157)) #174
print(175, list_outputs_add[157], len(h_o158)) #175
print(176, list_outputs_add[158], len(h_o159)) #176
print(177, list_outputs_add[159], len(h_o160)) #177
print(178, list_outputs_add[160], len(h_o161)) #178
print(179, list_outputs_add[161], len(h_o162)) #179
print(180, list_outputs_add[162], len(h_o163)) #180
print(181, list_outputs_add[163], len(h_o164)) #181
print(182, list_outputs_add[164], len(h_o165)) #182
print(183, list_outputs_add[165], len(h_o166)) #183
print(184, list_outputs_add[166], len(h_o167)) #184
print(185, list_outputs_add[167], len(h_o168)) #185
print(186, list_outputs_add[168], len(h_o169)) #186
print(187, list_outputs_add[169], len(h_o170)) #187
print(188, list_outputs_add[170], len(h_o171)) #188
print(189, list_outputs_add[171], len(h_o172)) #189
print(190, list_outputs_add[172], len(h_o173)) #190
print(191, list_outputs_add[173], len(h_o174)) #191
print(192, list_outputs_add[174], len(h_o175)) #192
...
dict_output = {list_dimensions[0]: h_strategy, #1
               ...
               list_outputs_add[76]: h_o77, #94
               list_outputs_add[77]: h_o78, #95
               
               list_outputs_add[78]: h_o79, #96
               list_outputs_add[79]: h_o80, #97
               list_outputs_add[80]: h_o81, #98
               list_outputs_add[81]: h_o82, #99
               list_outputs_add[82]: h_o83, #100
               list_outputs_add[83]: h_o84, #101
               list_outputs_add[84]: h_o85, #102
               list_outputs_add[85]: h_o86, #103
               list_outputs_add[86]: h_o87, #104
               list_outputs_add[87]: h_o88, #105
               list_outputs_add[88]: h_o89, #106
               list_outputs_add[89]: h_o90, #107
               list_outputs_add[90]: h_o91, #108
               list_outputs_add[91]: h_o92, #109
               list_outputs_add[92]: h_o93, #110
               list_outputs_add[93]: h_o94, #111
               list_outputs_add[94]: h_o95, #112
               list_outputs_add[95]: h_o96, #113
               list_outputs_add[96]: h_o97, #114
               list_outputs_add[97]: h_o98, #115
               list_outputs_add[98]: h_o99, #116
               list_outputs_add[99]: h_o100, #117
               list_outputs_add[100]: h_o101, #118
               list_outputs_add[101]: h_o102, #119
               list_outputs_add[102]: h_o103, #120
               list_outputs_add[103]: h_o104, #121
               list_outputs_add[104]: h_o105, #122
               list_outputs_add[105]: h_o106, #123
               list_outputs_add[106]: h_o107, #124
               list_outputs_add[107]: h_o108, #125
               list_outputs_add[108]: h_o109, #126
               list_outputs_add[109]: h_o110, #127
               list_outputs_add[110]: h_o111, #128
               list_outputs_add[111]: h_o112, #129
               list_outputs_add[112]: h_o113, #130
               list_outputs_add[113]: h_o114, #131
               list_outputs_add[114]: h_o115, #132
               list_outputs_add[115]: h_o116, #133
               list_outputs_add[116]: h_o117, #134
               list_outputs_add[117]: h_o118, #135
               list_outputs_add[118]: h_o119, #136
               list_outputs_add[119]: h_o120, #137
               list_outputs_add[120]: h_o121, #138
               list_outputs_add[121]: h_o122, #139
               list_outputs_add[122]: h_o123, #140
               list_outputs_add[123]: h_o124, #141
               list_outputs_add[124]: h_o125, #142
               list_outputs_add[125]: h_o126, #143
               list_outputs_add[126]: h_o127, #144
               list_outputs_add[127]: h_o128, #145
               list_outputs_add[128]: h_o129, #146
               list_outputs_add[129]: h_o130, #147
               list_outputs_add[130]: h_o131, #148
               list_outputs_add[131]: h_o132, #149
               list_outputs_add[132]: h_o133, #150
               list_outputs_add[133]: h_o134, #151
               list_outputs_add[134]: h_o135, #152
               list_outputs_add[135]: h_o136, #153
               list_outputs_add[136]: h_o137, #154
               list_outputs_add[137]: h_o138, #155
               list_outputs_add[138]: h_o139, #156
               list_outputs_add[139]: h_o140, #157
               list_outputs_add[140]: h_o141, #158
               list_outputs_add[141]: h_o142, #159
               list_outputs_add[142]: h_o143, #160
               list_outputs_add[143]: h_o144, #161
               list_outputs_add[144]: h_o145, #162
               list_outputs_add[145]: h_o146, #163
               list_outputs_add[146]: h_o147, #164
               list_outputs_add[147]: h_o148, #165     
               list_outputs_add[148]: h_o149, #166
               list_outputs_add[149]: h_o150, #167
               list_outputs_add[150]: h_o151, #168   
               list_outputs_add[151]: h_o152, #169
               list_outputs_add[152]: h_o153, #170
               list_outputs_add[153]: h_o154, #171   
               list_outputs_add[154]: h_o155, #172
               list_outputs_add[155]: h_o156, #173
               list_outputs_add[156]: h_o157, #174
               list_outputs_add[157]: h_o158, #175
               list_outputs_add[158]: h_o159, #176
               list_outputs_add[159]: h_o160, #177
               list_outputs_add[160]: h_o161, #178
               list_outputs_add[161]: h_o162, #179
               list_outputs_add[162]: h_o163, #180
               list_outputs_add[163]: h_o164, #181
               list_outputs_add[164]: h_o165, #182
               list_outputs_add[165]: h_o166, #183
               list_outputs_add[166]: h_o167, #184
               list_outputs_add[167]: h_o168, #185
               list_outputs_add[168]: h_o169, #186
               list_outputs_add[169]: h_o170, #187
               list_outputs_add[170]: h_o171, #188
               list_outputs_add[171]: h_o172, #185
               list_outputs_add[172]: h_o173, #186
               list_outputs_add[173]: h_o174, #187
               list_outputs_add[174]: h_o175, #188
                           }
