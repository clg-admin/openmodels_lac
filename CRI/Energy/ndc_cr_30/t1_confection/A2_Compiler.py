...
Fuels_techs = [ i for i in range( len( list_fuel_or_tech ) ) if (params['techs'] in list_fuel_or_tech[i] and not params['E6'] in list_fuel_or_tech[i]) ]
Fuels_techs_2_dems = {}
    ...
    for n in range( len( df_index_list ) ):
                ...
                if define_restriction == True:
                    ...
                    if start_year == params['continuos']: # means we need to take the residual capacity into consideration
                        ...
                        for y in range( len( time_range_vector ) ):
                            ...
                            # if this_tech == "TRNMICDSL" and this_param == "TotalTechnologyAnnualActivityLowerLimit":
                            #     sys.exit(39)
        ...
        if s == 0:  # we store the parameters without years
            ...
            for y in range(len(time_range_vector)):
                ...
                # if this_tech == "TRNFRERAIDSL" and this_param == "TotalTechnologyAnnualActivityLowerLimit":
                #     sys.exit(15)
